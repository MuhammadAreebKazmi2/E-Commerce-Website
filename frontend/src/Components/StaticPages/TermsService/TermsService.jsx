...
const TermsService = () => {
  return (
    <div className="entry-content">
        <h4>OVERVIEW</h4>
        <p>
          This website is operated by Habib Dukaan. Throughout the site, the terms “we”, “us” and “our” refer to Habib Dukaan. Habib Dukaan offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        </p>
        <p>
        ...
        <h4>SECTION 5 – CONTACT INFORMATION</h4>
        <p>Questions about the Terms of Service should be sent to us at <a href="mailto:kashif.tanwir@habib.edu.pk">kashif.tanwir@habib.edu.pk</a></p>
    </div>
